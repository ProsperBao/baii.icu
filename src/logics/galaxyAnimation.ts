...
function getPointerInput(callback: any, element: any = document, delay = 600) {
...
export class StarField {
  ...
  constructor(howManyStars: number, canvas: HTMLCanvasElement, depth = 2, UIFadeDelay = 1) {
    ...
    false && getPointerInput(handlePointer)
  ...
  emptyStarField() {
    this.stars = Array.from({ length: this.howManyStars })
  }
